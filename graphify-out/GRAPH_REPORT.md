...
## Summary
- 1429 nodes · 2296 edges · 198 communities (115 shown, 83 thin omitted)
- Extraction: 93% EXTRACTED · 7% INFERRED · 0% AMBIGUOUS · INFERRED: 152 edges (avg confidence: 0.84)
...
## Communities (198 total, 83 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.07
Nodes (26): ApiResponse, ErrorCode, JsonResponse, CurrentCompany, CreateRoleAction, SynchronizeCompanyUserAccessAction, UpdateRoleAction, CompanyUserController (+18 more)

### Community 1 - "Community 1"
Cohesion: 0.06
Nodes (21): CreateCustomerAction, Company, Company, ProvisionGenericCustomer, UpdateCustomerAction, CustomerController, Request, StoreCustomerRequest (+13 more)

### Community 2 - "Community 2"
Cohesion: 0.07
Nodes (22): CompanyUserResource, Request, PermissionResource, Request, Request, RoleResource, AuditLogResource, Request (+14 more)
...
Cohesion: 0.08
Nodes (13): ApiException, ReservedNcf, NcfSequenceException, NcfSequenceController, CurrentCompany, JsonResponse, StoreNcfSequenceRequest, NcfSequenceResource (+5 more)
...
Cohesion: 0.08
Nodes (27): i18n, customers, editing, emptyForm(), error, form, load(), loading (+19 more)
...
Cohesion: 0.13
Nodes (10): CompanyModel, CustomerAddress, CustomerContact, CustomerCreditMovement, CompanySubscription, BelongsTo, BelongsToMany, SubscriptionPlan (+2 more)

### Community 12 - "Community 12"
Cohesion: 0.16
Nodes (19): addSequence(), documentTypes, error, load(), loading, message(), savingSeq, seqForm (+11 more)
...
Cohesion: 0.16
Nodes (7): BelongsToMany, User, AuditLogPolicy, Authenticatable, HasApiTokens, HasFactory, Notifiable
...
Cohesion: 0.28
Nodes (5): PaymentMethod, Tax, Auditable, HasPublicUlid, SoftDeletes
...
Cohesion: 0.20
Nodes (5): CreateBranchAction, BranchController, JsonResponse, Request, UpdateBranchRequest
...
Cohesion: 0.19
Nodes (4): UpdateCompanyUserAccessRequest, UpdateRoleRequest, StoreTaxRequest, FormRequest
...
Cohesion: 0.33
Nodes (4): CurrentCompany, JsonResponse, SettingController, DocumentType
...
Cohesion: 0.25
Nodes (5): authorizeApi(), EnsureBranchContext, Closure, Request, Response

### Community 37 - "Community 37"
Cohesion: 0.27
Nodes (3): Company, BelongsToMany, CompanyPolicy
...
Cohesion: 0.28
Nodes (3): CompleteOnboardingAction, OnboardingController, JsonResponse
...
Cohesion: 0.53
Nodes (4): EnsurePermission, Closure, Request, Response
...
Cohesion: 0.40
Nodes (5): Documentación viva, Fuentes de verdad (en orden de prioridad), Grafo de conocimiento, OmniPOS Modular SaaS — Instrucciones del proyecto, Reglas duras (resumen)
...
## Knowledge Gaps
- **417 isolated node(s):** `Fuentes de verdad (en orden de prioridad)`, `Documentación viva`, `Reglas duras (resumen)`, `Grafo de conocimiento`, `Fuentes de verdad (en orden de prioridad)` (+412 more)
...
- **Why does `Customer` connect `Community 1` to `Community 11`, `Community 21`?**
  _High betweenness centrality (0.020) - this node is a cross-community bridge._
- **Why does `User` connect `Community 14` to `Community 0`, `Community 2`, `Community 36`, `Community 37`, `Community 68`, `Community 8`, `Community 9`, `Community 74`, `Community 13`, `Community 20`, `Community 21`, `Community 23`, `Community 56`, `Community 24`?**
  _High betweenness centrality (0.016) - this node is a cross-community bridge._
- **Why does `CurrentCompany` connect `Community 0` to `Community 37`, `Community 8`, `Community 20`, `Community 23`, `Community 56`?**
