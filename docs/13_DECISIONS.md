...
| 017 | 2026-07-10 | Playwright E2E con SQLite recreada y servidor no reutilizable por defecto | Evita fugas de estado entre corridas (especialmente base E2E y rate limiting) y hace reproducible CI. Reutilizar servidor se permite solo de forma explícita para depuración local. |
