...
- [x] Grafo Graphify actualizado e incorporado al grafo global como `omnipos-modular-saas` (534 nodos, 509 relaciones; sin duplicados ni referencias colgantes). El extractor conserva una autorelación falsa en `app/Models/User.php` por una colisión de alias de importación.
