...
- [ ] Suite **Playwright E2E** de los 10 flujos de negocio como test runner dedicado. Base estabilizada: 15 escenarios, incluido POS fiscal, pago mixto/multimoneda (tarjeta DOP + efectivo USD), cierre de caja/arqueo, ciclo 2FA y activación/desactivación de módulos con protección del núcleo; faltan restaurante, compras/FEFO, vencimientos, e-CF Mock y venta sin stock.
